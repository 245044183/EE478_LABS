...
#
# Generated by export_simulation on Mon Oct 21 08:54:56 -0400 2019
#
################################################################################
...
'-reset_run' switch to the './mclk_gen.sh' script.

./mclk_gen.sh -reset_run
...
./mclk_gen.sh -noclean_files

For more information on the script, please type './mclk_gen.sh -help'.
